...
<div id="ouerehsssr" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#ouerehsssr table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}
&#10;#ouerehsssr thead, #ouerehsssr tbody, #ouerehsssr tfoot, #ouerehsssr tr, #ouerehsssr td, #ouerehsssr th {
  border-style: none;
}
&#10;#ouerehsssr p {
  margin: 0;
...
&#10;#ouerehsssr .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}
&#10;#ouerehsssr .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
&#10;#ouerehsssr .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
&#10;#ouerehsssr .gt_column_spanner_outer:first-child {
  padding-left: 0;
}
&#10;#ouerehsssr .gt_column_spanner_outer:last-child {
  padding-right: 0;
}
&#10;#ouerehsssr .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
&#10;#ouerehsssr .gt_spanner_row {
  border-bottom-style: hidden;
}
&#10;#ouerehsssr .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#ouerehsssr .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
&#10;#ouerehsssr .gt_from_md > :first-child {
  margin-top: 0;
}
&#10;#ouerehsssr .gt_from_md > :last-child {
  margin-bottom: 0;
}
&#10;#ouerehsssr .gt_row {
  padding-top: 8px;
...
&#10;#ouerehsssr .gt_row_group_first td {
  border-top-width: 2px;
}
&#10;#ouerehsssr .gt_row_group_first th {
  border-top-width: 2px;
}
&#10;#ouerehsssr .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
&#10;#ouerehsssr .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}
&#10;#ouerehsssr .gt_first_summary_row.thick {
  border-top-width: 2px;
}
&#10;#ouerehsssr .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#ouerehsssr .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
&#10;#ouerehsssr .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#ouerehsssr .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#ouerehsssr .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}
&#10;#ouerehsssr .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
&#10;#ouerehsssr .gt_font_normal {
  font-weight: normal;
}
&#10;#ouerehsssr .gt_font_bold {
  font-weight: bold;
}
&#10;#ouerehsssr .gt_font_italic {
  font-style: italic;
}
&#10;#ouerehsssr .gt_super {
  font-size: 65%;
}
&#10;#ouerehsssr .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}
&#10;#ouerehsssr .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}
&#10;#ouerehsssr .gt_indent_1 {
  text-indent: 5px;
}
&#10;#ouerehsssr .gt_indent_2 {
  text-indent: 10px;
}
&#10;#ouerehsssr .gt_indent_3 {
  text-indent: 15px;
}
&#10;#ouerehsssr .gt_indent_4 {
  text-indent: 20px;
}
&#10;#ouerehsssr .gt_indent_5 {
  text-indent: 25px;
}
&#10;#ouerehsssr .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}
&#10;#ouerehsssr div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
\textbf{Model 5}: \text{logit}(\mu_i) &= f(\text{Date_Year}_i, \text{City_Town_Name}_c) + \text{Lat}_i\beta_2 + \text{Lon}_i\beta_3 + \sum_{p} X_{ip}\beta_p \\
\textbf{Model 6}: \text{logit}(\mu_i) &= f(\text{Date_Year}_i, \text{City_Town_Name}_c) + g(\text{Lat}_i, \text{Lon}_i) + \sum_{p} X_{ip}\beta_p \\
\end{aligned}
$$
