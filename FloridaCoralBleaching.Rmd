...
```{r Temporal Effects Facet, fig.align='center', out.width="90%", fig.cap="Figure 6: County-Specific Trends"}
...
```{r Temporal Effects Overlay, fig.align='center', out.width="90%", fig.cap="Figure 7: Aggregated Trends"}
...
```{r Spatial Effects, fig.align='center', out.width="90%", fig.cap="Figure 8: Spatial Effects"}
