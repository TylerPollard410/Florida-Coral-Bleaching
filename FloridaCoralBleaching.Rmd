...
```{r PPC Distribution, fig.align='center', out.width="90%", fig.cap="Figure 4: Posterior Predictive Distribution vs Observed Percent Bleaching from 250 posterior draws"}
#### Density ----
set.seed(52) # for reproducibility
...
```{r PPC Stats, fig.align='center', out.width = "90%", fig.cap = "Figure 5: Posterior Predictive Checks for Distributional Statistics"}
#### Stats ----
# Make stat functions
