...
```{r Temporal Effects, fig.align='center', out.width="90%", fig.cap="Figure 6: Temporal Effects"}
...
```{r Spatial Effects, fig.align='center', out.width="90%", fig.cap="Figure 7: Spatial Effects"}
