...
* **Fixed Effects**: $\beta_p \sim \mathcal{N}(0,5)$ for all covariates $p$.
...
We tested multiple models to evaluate different approaches for capturing spatiotemporal variation in coral bleaching. Leave-One-Out Cross-Validation (LOO-CV) was used for model selection.
